...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Track source for the UI (deduplicate by label)
            label = course_title
            if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get the outline of a course including its title, link, and complete list of lessons. Use this for questions about what a course covers, its structure, or lesson listings.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        try:
            ...
            output = f"Course: {metadata.get('title', course_title)}\n"
            output += f"Link: {metadata.get('course_link', 'N/A')}\n"
            output += f"\nLessons:\n"
            ...
            if lessons_json:
                ...
                for lesson in lessons:
                    output += f"  Lesson {lesson['lesson_number']}: {lesson['lesson_title']}\n"
            else:
                output += "  No lesson information available.\n"
